...
@section('content')
	@if (Session::has('success'))
		<div class="alert alert-success mt-2 text-center" role="alert">
			<h2>Success!</h2> {{ Session::get('success') }}
		</div>
	@endif
	@if ($errors->any())
	...
	<div class="row text-center">
		<div class="col-md-12">
			...
			<h3 class="mt-4">In one year, smoking costs you about:</h3>
						...
						<div class="row">
							...
							<div class="col-md-2">
								<div class="form-group">
									...
									<input type="text" class="form-control" readonly="readonly" name="savings" id="savings" v-model="formatPrice(multiply)">
